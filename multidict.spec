...
Source0  : https://files.pythonhosted.org/packages/b6/22/ae21cedaa0e6d35e84e8ab57700dcf3d4609421ebe113e1aaafc468eec42/multidict-4.7.4.tar.gz
...
%prep
%setup -q -n multidict-4.7.4
cd %{_builddir}/multidict-4.7.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578940838
...
cp %{_builddir}/multidict-4.7.4/LICENSE %{buildroot}/usr/share/package-licenses/multidict/9bda5c883efd96d295207e8ca8a4f38320fc2cf7
