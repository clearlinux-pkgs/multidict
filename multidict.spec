...
Version  : 4.6.0
Release  : 12
URL      : https://files.pythonhosted.org/packages/b7/8f/1ec863af20356921e9eb9b69a2ccb55fbe24550270354f17acbdaa6965cd/multidict-4.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/b7/8f/1ec863af20356921e9eb9b69a2ccb55fbe24550270354f17acbdaa6965cd/multidict-4.6.0.tar.gz
...
%prep
%setup -q -n multidict-4.6.0
cd %{_builddir}/multidict-4.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574277564
...
cp %{_builddir}/multidict-4.6.0/LICENSE %{buildroot}/usr/share/package-licenses/multidict/9bda5c883efd96d295207e8ca8a4f38320fc2cf7
