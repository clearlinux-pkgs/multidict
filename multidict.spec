...
Source0  : https://files.pythonhosted.org/packages/d2/5a/e95b0f9ebacd42e094e229a9a0a9e44d02876abf64969d0cb07dadcf3c4a/multidict-5.0.0.tar.gz
...
%prep
%setup -q -n multidict-5.0.0
cd %{_builddir}/multidict-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602519333
...
cp %{_builddir}/multidict-5.0.0/LICENSE %{buildroot}/usr/share/package-licenses/multidict/9bda5c883efd96d295207e8ca8a4f38320fc2cf7
