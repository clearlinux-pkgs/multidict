...
Source0  : https://files.pythonhosted.org/packages/84/96/5503ba866d8d216e49a6ce3bcb288df8a5fb3ac8a90b8fcff9ddcda32568/multidict-4.7.3.tar.gz
...
%prep
%setup -q -n multidict-4.7.3
cd %{_builddir}/multidict-4.7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578155275
...
cp %{_builddir}/multidict-4.7.3/LICENSE %{buildroot}/usr/share/package-licenses/multidict/9bda5c883efd96d295207e8ca8a4f38320fc2cf7
