...
Source0  : https://files.pythonhosted.org/packages/8a/74/61547af55c077b8d2e3648c2af74c08fa1e382665b290468db7ba54db2ea/multidict-4.6.1.tar.gz
...
%prep
%setup -q -n multidict-4.6.1
cd %{_builddir}/multidict-4.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574348677
...
cp %{_builddir}/multidict-4.6.1/LICENSE %{buildroot}/usr/share/package-licenses/multidict/9bda5c883efd96d295207e8ca8a4f38320fc2cf7
